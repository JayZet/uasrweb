<div class="container">
 <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h1 mb-0 text-gray-800">Upload Bukti Pembayaran PTTA</h1>
    </div>
<!-- form -->
<?= $this->session->flashdata('sukses'); ?>
<?php if(isset($error)) { echo $error; }; ?>
 <form action="<?php echo base_url('Login_mhs/ptta/'.$mahasiswa->username); ?>" method="post" enctype="multipart/form-data">
    <hr>
    <div class="row">

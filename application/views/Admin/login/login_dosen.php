...
<div class="row mt-4">
		...
		<div class="col-lg-4 col-md-12 col-sm-12">
			...
			<form action="<?= base_url('Admin/Login_dosen/aksi_login') ?>" method="post">
			
				<div class="form-group">
					<label for="exampleInputEmail1" style="color: teal;">Niy</label>
					<input type="text" class="form-control form-control-user" id="niy" name="niy">
